...
Here we defined a class named "Account". Starting with a main function  *"__-init___"*, which define the different token that a *user_account* will be constitued
